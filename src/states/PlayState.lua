    ...
    for k, ball in pairs(self.ball) do
        ...
        for k, brick in pairs(self.bricks) do
            ...
            if brick.inPlay and ball:collides(brick) then
                ...
                elseif (self.level % 3) == 0 and lockedBrick == true and math.random(math.floor(self.hitcount/2)) == math.floor(self.hitcount/2)  then    
                ...
                if self.paddlerecoverPoints > 1500 then
                    gSounds['recover']:play()
